    ...
    render: function() {
      return (
        React.createElement("form", null, 
          React.createElement("p", null, this.state.valueError), 
          React.createElement("p", null, this.state.emailError), 
          React.createElement("div", {className: "text-input-container question-text-input-container"}, 
